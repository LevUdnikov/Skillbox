...
for month in range(1, 11):
    needed_grant += expenses - educational_grant
    print("{} месяц траты {:.2f} не хватает {:.2f}".format(month, expenses, needed_grant))
    expenses += expenses * 0.03
print("Нужно попросить у родителей {:.2f} рублей".format(needed_grant))
