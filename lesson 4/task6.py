...
guest_square = int(input("Кубик Кости: "))
owners_square = int(input("Кубик владельца: "))
if guest_square >= owners_square:
  print("Разность:", guest_square - owners_square)
  print("Игрок платит")
else:
  print("Сумма:", guest_square + owners_square)
