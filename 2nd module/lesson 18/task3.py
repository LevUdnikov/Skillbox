...
# URL API для получения информации о кораблях Star Wars
url = 'https://swapi.dev/api/starships/'

# Выполняем запрос к API для получения информации о кораблях
...
# Получаем информацию о пилотах Millennium Falcon
pilots_info = []
